...
public class HeadDownTransformHandler implements ApplyCameraTransformsCallback {
    ...
    public static final Quaternionf QUATERNION_180_X = RotationAxis.POSITIVE_X.rotationDegrees(180.0F);
    public static final Quaternionf QUATERNION_180_Y = RotationAxis.POSITIVE_Y.rotationDegrees(180.0F);
